...
def collect_data(model_type, pipe, coco_path, cali_data_path, cali_prompt_data_n=64, step_size=-1, callback_keys=[], batch_size=4):
...
def calibration_data_generation(model_type, 
    ...
    if os.path.exists(cali_data_path):
        ...
        cali_data = collect_data(model_type, pipe, coco_path, cali_data_path, cali_prompt_data_n, step_size, callback_keys=_callback_tensor_inputs, batch_size=batch_size)
